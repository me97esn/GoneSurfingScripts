...
# print(ifft2(1, 1, b2))
print('-----------------')
print("0,:" ,ifft2(0, 0, b2,random_2darray[0].size, random_2darray.size), ", should be: ", random_2darray[0][0])
print("8,6:" ,ifft2(8, 6, b2,random_2darray[0].size, random_2darray.size), ", should be: ", random_2darray[8][6])
print("9,5:" ,ifft2(9, 5, b2,random_2darray[0].size, random_2darray.size), ", should be: ", random_2darray[9][5])
print()
